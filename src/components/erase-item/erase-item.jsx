    ...
    return(
        ...
        <div className="erasebox flex items-center justify-center">
            <div className="modal-body">
                <h3 className="text-center mt-5 text-xl"><strong>Are you sure?</strong></h3>
                <button onClick={() => eraseItem(item)} className="m-5">Erase</button>
                <button onClick={(e) => changeModalStatus(false)} className="mr-5">Cancel</button>
            </div>
            <div className="closeDiv" onClick={(e) => changeModalStatus(false)}>
